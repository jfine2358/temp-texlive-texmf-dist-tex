...
\def\dbtversion {Mar. 2011} % version of DocBy.TeX

% Mar. 2011:  - fnote: tiskne krátká slova místo dlouhých
%             - index: netiskne závorky
%             - \module umo¾ní naèíst název\_modulu s podtr¾ítkem
% Jan. 2009:  - ^^I vytiskne osm mezer, ne tri
%             - pridano makro \part
% Nov. 2008:  - fith nahrazeno xyz
%             - pøepínání stejných ns:, úprava makra \refns
%             - vykostìmí mezer z \namespace, \endnamespace
%             - run me twice -> run me again
% Oct. 2008:  - první veøejná verze

%%%%%%%%%%%%%%%%%%% Interní názvy

\ifx\chyph\undefined      % format: plain, anglicke nazvy
   \def\titmodule{Module}
   \def\tittoc{Table Of Contents}
   \def\titindex{Index}
   \def\titversion{version }
   \def\opartname{>> PART}
\else                     % format: csplain, ceske nazvy
   \def\titmodule{Modul}
   \def\tittoc{Obsah}
...
\immediate\write16{This is DocBy.TeX, version \dbtversion, modes:
    ...
    \ifx\chyph\undefined \else cs\fi plain}
