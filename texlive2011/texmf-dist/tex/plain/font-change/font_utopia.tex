...
\def\twentyi{\font\fzzozznzzt=   futmii at20pt \fzzozznzzt}%
\def\eighteeni{\font\fzzozznzzt= futmii at18pt \fzzozznzzt}%
\def\sixteeni{\font\fzzozznzzt=  futmii at16pt \fzzozznzzt}%
\def\fourteeni{\font\fzzozznzzt= futmii at14pt \fzzozznzzt}%
\def\twelvei{\font\fzzozznzzt=   futmii at12pt \fzzozznzzt}%
\font\teni=         futmii% mdputri7m  of mathdesign works but spacing problem needs \fontdimen2\teni (e.g. dx)
\def\ninei{\font\fzzozznzzt=        futmii at9pt \fzzozznzzt}%
\def\eighti{\font\fzzozznzzt=       futmii at8pt \fzzozznzzt}%
\font\seveni=       futmii at7pt
\def\sixi{\font\fzzozznzzt=         futmii at6pt \fzzozznzzt}%
\font\fivei=        futmii at5pt
%
% math symbols (Family 2)
\def\twentysy{\font\fzzozznzzt=  futsy at20pt \fzzozznzzt}%
\def\eighteensy{\font\fzzozznzzt=futsy at18pt \fzzozznzzt}%
\def\sixteensy{\font\fzzozznzzt= futsy at16pt \fzzozznzzt}%
\def\fourteensy{\font\fzzozznzzt=futsy at14pt \fzzozznzzt}%
\def\twelvesy{\font\fzzozznzzt=  futsy at12pt \fzzozznzzt}%
\font\tensy=        futsy % md-utr7y of mathdesign also works
\def\ninesy{\font\fzzozznzzt=       futsy at9pt \fzzozznzzt}%
\def\eightsy{\font\fzzozznzzt=      futsy at8pt \fzzozznzzt}%
\font\sevensy=      futsy at7pt
\def\sixsy{\font\fzzozznzzt=        futsy at6pt \fzzozznzzt}%
...
%
\fontdimen2\teni=-0.01pt % needed with md... mathdesign family, this even improves futmii and gives better results
%
\rm