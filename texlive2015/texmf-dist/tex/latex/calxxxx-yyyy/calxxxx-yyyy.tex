...
% date: 2015/03/29
%
% Copyright (C) 2010 - 2015 H.-Martin M\"{u}nch (Martin dot Muench at Uni-Bonn dot de)
...
%   README.pdf, cal2015-2032_DE.pdf, cal2015-2032_DK.pdf,
%   and cal2015-2032_EN.pdf.
%
% In memoriam
...
\usepackage{babel}[2014/09/25]% v3.9l
...
these calendars produced with calxxxx-yyyy 2015/03/29 v1.0h by \texttt{Martin.Muench@Uni-Bonn.de}; %
