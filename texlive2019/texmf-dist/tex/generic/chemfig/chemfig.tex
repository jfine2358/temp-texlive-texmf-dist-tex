...
\def\CF@schemestart@a[#1]{%
	...
	\CF@valuetomacro\CF@arrowhead[-CF]{arrow head}%
	\CF@eexp@second{\def\CF@arrowtip}{\expandafter\CF@gobarg\CF@arrowhead}%
...
\definearrow3{<->}{%
	\CF@arrow@shift@nodes{#3}%
	\expandafter\draw\expandafter[\CF@arrow@current@style,\CF@arrowtip-\CF@arrowtip](\CF@arrow@start@node)--(\CF@arrow@end@node);%
	\CF@arrow@display@label{#1}{0.5}+\CF@arrow@start@node{#2}{0.5}-\CF@arrow@end@node
}
